...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['role:procurement', 'can:dashboard.view', 'identity.verified'])->group(function () {
        ...
        Route::get('/procurement/documents', [ProcurementDocumentController::class, 'index'])->name('procurement.documents.index');
        Route::post('/procurement/documents', [ProcurementDocumentController::class, 'store'])->name('procurement.documents.store');
        ...
        Route::get('/procurement/documents/{document}', [ProcurementDocumentController::class, 'show'])->name('procurement.documents.show');
