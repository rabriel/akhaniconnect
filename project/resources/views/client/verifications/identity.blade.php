@extends('layouts.app', [
    'title' => 'Client SA ID Verification | Akhani Connect',
    'heading' => 'SA ID Verification',
    'subheading' => 'Verify your South African ID before accessing the client workspace.',
])
...
@section('content')
    <div class="row g-5 g-xl-8">
        <div class="col-xl-7">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('client.identity-verification.store') }}">
                        @csrf
                        <div class="mb-5">
