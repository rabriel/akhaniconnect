@extends('layouts.app', [
    'title' => 'Recruitment SA ID Verification | Akhani Connect',
    'heading' => 'SA ID Verification',
    'subheading' => 'Verify your South African ID before accessing the recruitment workspace.',
])
...
@section('content')
    <div class="row g-5 g-xl-8">
        <div class="col-xl-7">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('recruitment.identity-verification.store') }}">
                        @csrf
                        <div class="mb-5">
