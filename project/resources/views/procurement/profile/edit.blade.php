@extends('layouts.app', [
    'title' => 'Procurement Profile | Akhani Connect',
    'heading' => 'My Profile',
    'subheading' => 'Complete your procurement profile details for identity and onboarding readiness.',
])
...
@section('content')
    <div class="card">
        ...
        <div class="card-body pt-0">
            <form method="POST" action="{{ route('procurement.profile.update') }}">
                @csrf
                @method('PUT')
                ...
                <div class="row mb-6">
                    <div class="col-lg-6 fv-row">
                        <label class="form-label fs-6 fw-bold mb-3">Email address</label>
                    ...
                    <div class="col-lg-6 fv-row">
                        <label class="form-label fs-6 fw-bold mb-3">Cell number</label>
