@extends('layouts.app', [
    'title' => 'Procurement SA ID Verification | Akhani Connect',
    'heading' => 'SA ID Verification',
    'subheading' => 'Verify your South African ID before accessing the procurement workspace.',
])
...
@section('content')
    <div class="row g-5 g-xl-8">
        <div class="col-xl-7">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('procurement.identity-verification.store') }}">
                        @csrf
                        <div class="mb-5">
